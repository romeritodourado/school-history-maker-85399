...
const StudentList = () => {
  ...
  const fetchStudents = async () => {
    try {
      ...
      } else if (['school_admin', 'vice_school_admin', 'secretary'].includes(currentUserRole || '')) {
                ...
                <CardContent>
                  ...
                  <div className="flex gap-2">
                    ...
                    {(currentUserRole === 'super_admin' || 
                      ...
                      (['school_admin', 'vice_school_admin', 'secretary'].includes(currentUserRole || '') && student.school_id === currentUserProfile?.school_id)) && (
